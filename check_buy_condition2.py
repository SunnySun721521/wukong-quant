...
print("\n=== 2020年7月-8月 数据分析（2019年起） ===")
print(f"{'日期':<12} {'收盘价':>8} {'ma250':>8} {'站上年线':>6} {'v_ma5':>10} {'v_ma60':>10} {'量放大':>5} {'缩量':>5} {'ma20':>8} {'回踩':>6}")
print("-" * 95)

for date in df.index:
    if date >= pd.Timestamp('2020-07-01') and date <= pd.Timestamp('2020-08-15'):
        ...
        buy = "✓买入" if (above_ma250 == "是" and vol放大 == "是" and vol缩量 == "是" and 回踩 == "是") else ""
        
        print(f"{str(date.date()):<12} {close:>8.2f} {ma250:>8.2f} {above_ma250:>6} {v_ma5:>10.0f} {v_ma60:>10.0f} {vol放大:>5} {vol缩量:>5} {ma20:>8.2f} {回踩:>6} {buy}")
